                    ...
                    <form action="updateUser" method="post" name="frm"
						...
						<table width="100%" cellspacing="0" cellpadding="3" align="center"
							...
							<tr style="background-color:#CCCCFF;">
								<td colspan="2">
									用户个人信息
									<input type="hidden" name="user.id" style="width:220px;" value="${user.id}" />
								</td>
							</tr>
							<tr>
								...
								<td align="left">		
									<input type="text" name="user.loginName" style="width:220px;" value="${user.loginName}" />									
								</td>
							</tr>
							<tr>
								<td align="right" style="width:320px;">
								...
								<td align="left">
									<input type="password" name="user.loginPwd" style="width:220px;" value="${user.loginPwd}"  />									
								</td>
							</tr>							
							<tr>
								<td align="right" style="width:320px;">
								...
								<td align="left">
									<input type="text" name="user.trueName" style="width:220px;" value="${user.trueName}"  />									
								</td>
							</tr>						
							<tr>
								<td align="right" style="width:320px;">
								...
								<td align="left">
									<input type="text" name="user.phone" style="width:220px;" value="${user.phone}"  />									
								</td>
							</tr>
							<tr>
								<td align="right" style="width:320px;">
								...
								<td align="left">
									<input type="text" name="user.email" style="width:220px;" value="${user.email}"  />									
								</td>
							</tr>
							<tr>
								<td align="right" style="width:320px;">
								...
								<td align="left">
									<input type="text" name="user.address" style="width:220px;" value="${user.address}"  />									
								</td>
							</tr>
							<tr style="background-color:#CCCCFF;">
								<td colspan="2">
